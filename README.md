...
```sh
git clone https://github.com/NukedOne/dpaster
cd dpaster
...
Licensed under the [MIT License](https://opensource.org/licenses/MIT). For details, see [LICENSE](https://github.com/NukedOne/dpaster/blob/master/LICENSE).
